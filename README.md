...
2. `main.py` を実行すると、`scripts/detect_diff.py` → `scripts/clean_diff.py` → `scripts/analyse_diff.py` → `scripts/investigate_page.py` の順で動きます。
...
3. `scripts/investigate_page.py` も `GEMINI_API_KEY` が必要です。
